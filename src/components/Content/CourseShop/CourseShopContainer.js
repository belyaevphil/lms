...
import { CourseShop } from './CourseShop'
import { getAvailableCourses } from '../../../DAL/endpoints'

export class CourseShopContainer extends React.Component {
    _isMounted = false
    ...
    async fetchCourses(currentPage) {
        try {
            const data = await getAvailableCourses(currentPage)
